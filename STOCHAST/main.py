...
def secondImage():
    ...
    with containers.pop(random.randrange(len(containers))):
            col1.image(two, width=200)
            col2.write("""So this is revenge?. Im doing this for you. Whatever you may think of me I wouldn’t do something
...
def thirdImage():
    ...
    with containers.pop(random.randrange(len(containers))):
            col1.image(three, width=200)
            col2.write("""The eating grew to an end. He lowered his voice as though they could be heard over the din and
...
def fourthImage():
    ...
    with containers.pop(random.randrange(len(containers))):
            col1.image(four, width=200)
            col2.write("""Say Bermondsey and they wrinkle their noses. Still, it was the home before all homes. The river
...
def fiveImage():
    ...
    with containers.pop(random.randrange(len(containers))):
            col1.image(five, width=200)
            col2.write("""Im all out of pop groups, was I wrong to be angry? You’ve done everything u could. I sighed heavily. I
